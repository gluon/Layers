/**
 * Layers for Processing 2.x 
 * Using multiple layers in Processing
 * http://julienbayle.net/processing-layers
 *
 * Copyright (c) 2013 Julien Bayle http://julienbayle.net
 *
 ...
 * 
 * @author      Julien Bayle http://julienbayle.net
 * @modified    09/05/2013
 * @version     1.0.0 (1)
 */

package net.julienbayle.processing.layers;
...
public abstract class Layers {
     ...
     */
    public Layers(PApplet parent, String renderer) {
        this.parent = parent;
        clipX = clipY = 0;
    ...
    public void text(char c) {
        if (recorder != null)
            recorder.text(c, clipHeight, clipHeight);
        g.text(c, clipHeight, clipHeight);
    }
    ...
    public void text(String str) {
        if (recorder != null)
            recorder.text(str, clipHeight, clipHeight);
        g.text(str, clipHeight, clipHeight);
    }
