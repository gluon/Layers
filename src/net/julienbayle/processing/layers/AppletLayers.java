...
public class AppletLayers {
     ...
     */
    public Layers getLayer(int i) {
        return (Layers) layers.get(i);
    }
    ...
    private void mousePressed() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).mousePressed();
        }
    }

    private void mouseReleased() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).mouseReleased();
        }
    }

    private void mouseClicked() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).mouseClicked();
        }
    }

    private void mouseDragged() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).mouseDragged();
        }
    }

    private void mouseMoved() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).mouseMoved();
        }
    }

    private void keyPressed() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).keyPressed();
        }
    }

    private void keyReleased() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).keyReleased();
        }
    }

    private void keyTyped() {
        for (int i = layers.size() - 1; i >= 0; i--) {
            ((Layers) layers.get(i)).keyTyped();
        }
    }
}
